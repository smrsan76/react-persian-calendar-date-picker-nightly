...
var Calendar = function Calendar(_ref) {
  ...
  var setActiveDate = function setActiveDate() {
    if (selectedDay) activeDate = (0, _utils.shallowCloneObject)(selectedDay);else if (selectedDays.length) activeDate = (0, _utils.shallowCloneObject)(selectedDays[0]);else if (selectedDayRange.from) activeDate = (0, _utils.shallowCloneObject)(selectedDayRange.from);else activeDate = (0, _utils.shallowCloneObject)(today);
  };
  ...
  var renderMonthDays = function renderMonthDays(isNewMonth) {
    ...
    return allDays.map(function (_ref2) {
      ...
      var isDisabled = disabledDays.some(function (disabledDay) {
  ...
  var renderMonthHeader = function renderMonthHeader(month) {
    ...
    }, getMonthYearText(showMultipleMonths ? month : isCycleCountEven)), shouldPrepareAnimation && _react["default"].createElement("span", {
      onAnimationEnd: handleAnimationEnd,
  ...
  var renderMonthSection = function renderMonthSection(month) {
    return _react["default"].createElement("div", {
    ...
    }, renderMonthDays(showMultipleMonths ? month : isCycleCountEven)), shouldPrepareAnimation && _react["default"].createElement("div", {
      onAnimationEnd: function onAnimationEnd(e) {
        handleAnimationEnd(e);
        updateDate();
      },
  ...
  var renderMonth = function renderMonth(month, key) {
    return _react["default"].createElement("div", {
      key: key,
      className: "Calendar__month"
    }, renderMonthHeader(month), _react["default"].createElement("div", {
      className: "Calendar__weekDays"
    }, renderWeekDays()), renderMonthSection(month));
  };

  var renderMonths = function renderMonths() {
    var currentMonth = (0, _utils.shallowCloneObject)(activeDate);
    ...
    if (showMultipleMonths) {
      if (displayYear) {
        var year = typeof displayYear === 'boolean' ? activeDate.year : displayYear;
        monthsStart = {
          year: year,
          month: 1
        };
    ...
    while (!(0, _utils.isBeforeDate)(monthsEnd, currentMonth)) {
      var monthKey = "".concat(currentMonth.year, "_").concat(currentMonth.month);
